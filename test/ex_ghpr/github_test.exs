defmodule ExGHPR.GithubTest do
  ...
  test "pull_request_api_url/2 should build API URL for whatever remote" do
    cwd = File.cwd! # Local ex_ghpr root directory, which should be valid git repository
    ...
    [
      ...
      local_repo = %Git.Repository{path: cwd}
      Git.remote(local_repo, ["add", remote_name, remote_url])
      assert Github.pull_request_api_url(cwd, remote_name) == {:ok, "https://api.github.com/repos/test_owner/test_repo/pulls"}
